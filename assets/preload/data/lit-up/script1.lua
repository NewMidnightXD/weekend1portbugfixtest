...
function onCreatePost()
    ...
    -- Lit Up: 0.1 - 0.2
    -- 2Hot: 0.2 - 0.4
    setShaderFloat('rainShaderSpr', 'uIntensity', 0.1);
...
function onUpdatePost(e)
    setShaderFloat('rainShaderSpr', 'uIntensity', (getProperty("songPercent") *0.1) +0.1);
    --debugPrint((getProperty("songPercent") *0.1) +0.1)
    time = time + e;
